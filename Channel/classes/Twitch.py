...
from Channel.classes.entities.Campaign import Campaign
from Channel.classes.entities.Drop import Drop
from Channel.classes.Exceptions import (
    StreamerDoesNotExistException,
    StreamerIsOfflineException,
)
from Channel.classes.Settings import (
    Events,
    FollowersOrder,
    Priority,
    Settings,
)
from Channel.classes.TwitchLogin import TwitchLogin
...
class Twitch(object):
    ...
    def get_spade_url(self, streamer):
        try:
            ...
            from Channel.constants import USER_AGENTS
