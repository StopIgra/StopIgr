...
from Channel.classes.Chat import ChatPresence, ThreadChat
from Channel.classes.entities.PubsubTopic import PubsubTopic
from Channel.classes.entities.Streamer import (
    Streamer,
    StreamerSettings,
)
from Channel.classes.Exceptions import StreamerDoesNotExistException
from Channel.classes.Settings import FollowersOrder, Priority, Settings
from Channel.classes.Twitch import Twitch
from Channel.classes.WebSocketsPool import WebSocketsPool
from Channel.logger import LoggerSettings, configure_loggers
...
class Channel:
    ...
    def analytics(
        ...
        if Settings.enable_analytics is True:
            from Channel.classes.AnalyticsServer import AnalyticsServer
